...
%----------------------------------------------------------------------------------------
\setkomavar{fromname}{Your Name Here} % Your name
\setkomavar{fromaddress}{Laserpartystreet\\1337 YY Amsterdam} % Your address
\setkomavar{fromphone}{+31 (0)6 134 555 74} % Your phone number
\setkomavar{fromemail}{LaserBro@gmail.com} % Your email address
\setkomavar{place}{Amsterdam} % City written before the date, put your city here if you want this
\setkomavar{signature}{Jerown Laserbro} % Your name as you want it to appear in the signature
\setkomavar{date}{10 augustus 2013} % Moet je neerzetten anders is de datum in het Engels.
